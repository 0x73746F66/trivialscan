...
trivialscan has default resilience to this hacking tool. The certificates used by this tool aren't signed by a trusted CA and the domain names are random (i.e. fail hostname matching)
