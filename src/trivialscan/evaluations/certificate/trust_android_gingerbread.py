...
class EvaluationTask(BaseEvaluationTask):
    ...
    def evaluate(self, certificate: BaseCertificate) -> Union[bool, None]:
        ...
        self.substitution_metadata["root_store_name"] = context.ANDROID_GINGERBREAD
        self.substitution_metadata["store_version"] = stores.android_2_3.__version__
        self.substitution_metadata["store_description"] = stores.android_2_3.__description__
        self.substitution_metadata["short_name"] = context.SHORT_LOOKUP.get(context.ANDROID_GINGERBREAD, context.ANDROID_GINGERBREAD)
        try:
            self.substitution_metadata["exists_in_store"] = store.exists(context_type=context.PLATFORM_ANDROID2_3)
            self.substitution_metadata["expired_in_store"] = store.expired_in_store(context_type=context.PLATFORM_ANDROID2_3)
