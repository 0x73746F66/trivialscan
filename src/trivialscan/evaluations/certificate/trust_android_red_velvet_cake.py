...
class EvaluationTask(BaseEvaluationTask):
    ...
    def evaluate(self, certificate: BaseCertificate) -> Union[bool, None]:
        ...
        self.substitution_metadata[
            "store_description"
        ] = stores.android_11.__description__
        self.substitution_metadata["short_name"] = context.SHORT_LOOKUP.get(
            context.ANDROID_RED_VELVET_CAKE, context.ANDROID_RED_VELVET_CAKE
        )
        try:
        ...
        return store.check_trust(context_type=context.PLATFORM_ANDROID11)
