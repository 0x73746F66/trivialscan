...
STYLES = {
    ...
    validator.VALIDATION_CLIENT_AUTHENTICATION: {
        "text": "Client Authentication",
        "represent_as": (CLI_VALUE_PASS, CLI_VALUE_FAIL),
        "colors": (CLI_COLOR_OK, CLI_COLOR_NOK),
    },
    validator.VALIDATION_CLIENT_AUTH_USAGE: {
        "text": "Provided client Certificate authentication usage",
        "represent_as": (CLI_VALUE_PASS, CLI_VALUE_FAIL),
        "colors": (CLI_COLOR_OK, CLI_COLOR_NOK),
    },
    validator.VALIDATION_NOT_EXPIRED: {
        "text": "Certificate is not expired",
        "represent_as": (CLI_VALUE_PASS, CLI_VALUE_FAIL),
        "colors": (CLI_COLOR_OK, CLI_COLOR_NOK),
    },
    validator.VALIDATION_ISSUED_PAST_TENSE: {
        "text": "Certificate issued in the past",
        "represent_as": (CLI_VALUE_PASS, CLI_VALUE_FAIL),
        "colors": (CLI_COLOR_OK, CLI_COLOR_NOK),
    },
    validator.VALIDATION_SUBJECT_CN_DEFINED: {
        "text": "Subject CN was defined",
        "represent_as": (CLI_VALUE_PASS, CLI_VALUE_FAIL),
        "colors": (CLI_COLOR_OK, CLI_COLOR_NOK),
    },
    validator.VALIDATION_SUBJECT_CN_VALID: {
        "text": "Subject CN has valid syntax",
        "represent_as": (CLI_VALUE_PASS, CLI_VALUE_FAIL),
        "colors": (CLI_COLOR_OK, CLI_COLOR_NOK),
    },
    validator.VALIDATION_MATCH_HOSTNAME: {
        "text": "Subject CN matches the server host name",
        "represent_as": (CLI_VALUE_PASS, CLI_VALUE_FAIL),
        "colors": (CLI_COLOR_OK, CLI_COLOR_NOK),
    },
    validator.VALIDATION_NOT_SELF_SIGNED: {
        "text": "Not a self-signed Certificate",
        "represent_as": (CLI_VALUE_PASS, CLI_VALUE_FAIL),
        "colors": (CLI_COLOR_OK, CLI_COLOR_NOK),
    },
    validator.VALIDATION_WEAK_SIG_ALGO: {
        "text": "Avoid known weak signature algorithms",
        "represent_as": (CLI_VALUE_PASS, CLI_VALUE_FAIL),
        "colors": (CLI_COLOR_OK, CLI_COLOR_NOK),
    },
    validator.VALIDATION_WEAK_KEYS: {
        "text": "Avoid known weak public key algorithms",
        "represent_as": (CLI_VALUE_PASS, CLI_VALUE_FAIL),
        "colors": (CLI_COLOR_OK, CLI_COLOR_NOK),
    },
    validator.VALIDATION_DEPRECATED_TLS_PROTOCOLS: {
        "text": "Avoid deprecated TLS protocols",
        "represent_as": (CLI_VALUE_PASS, CLI_VALUE_FAIL),
        "colors": (CLI_COLOR_OK, CLI_COLOR_NOK),
    },
    validator.VALIDATION_DEPRECATED_DNSSEC_ALGO: {
        "text": "Avoid deprecated DNSSEC algorithms",
        "represent_as": (CLI_VALUE_PASS, CLI_VALUE_FAIL),
        "colors": (CLI_COLOR_OK, CLI_COLOR_NOK),
    },
    validator.VALIDATION_BASIC_CONSTRAINTS_CA: {
        "text": "Leaf is not a CA",
        "represent_as": (CLI_VALUE_PASS, CLI_VALUE_FAIL),
        "colors": (CLI_COLOR_OK, CLI_COLOR_NOK),
    },
    validator.VALIDATION_VALID_TLS_USAGE: {
        "text": "Key usage appropriate for TLS",
        "represent_as": (CLI_VALUE_PASS, CLI_VALUE_FAIL),
        "colors": (CLI_COLOR_OK, CLI_COLOR_NOK),
    },
    validator.VALIDATION_REVOCATION: {
        "text": "Certificate chain not revoked",
        "represent_as": (CLI_VALUE_PASS, CLI_VALUE_FAIL),
        "colors": (CLI_COLOR_OK, CLI_COLOR_NOK),
    },
    validator.VALIDATION_ROOT_CA_TRUST: {
        "text": "Root CA Certificate is trusted",
        "represent_as": (CLI_VALUE_PASS, CLI_VALUE_FAIL),
        "colors": (CLI_COLOR_OK, CLI_COLOR_NOK),
    },
    validator.VALIDATION_VALID_DNSSEC: {
        "text": "DNSSEC Valid",
        "represent_as": (CLI_VALUE_PASS, CLI_VALUE_FAIL),
        "colors": (CLI_COLOR_OK, CLI_COLOR_NOK),
    },
    validator.VALIDATION_VALID_CAA: {
        "text": "CAA Valid",
        "represent_as": (CLI_VALUE_PASS, CLI_VALUE_FAIL),
        "colors": (CLI_COLOR_OK, CLI_COLOR_NOK),
    },
    validator.VALIDATION_OCSP_STAPLE_SATISFIED: {
        "text": "OCSP Staple satisfied",
        "represent_as": (CLI_VALUE_PASS, CLI_VALUE_FAIL),
        "colors": (CLI_COLOR_OK, CLI_COLOR_NOK),
    },
    validator.VALIDATION_OCSP_MUST_STAPLE_SATISFIED: {
