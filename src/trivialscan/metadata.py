...
class Metadata:
    ...
    trust_bsd: bool = field(default_factory=bool)
    trust_bsd_status: str = field(default_factory=str)
    ...
    trust_libcurl: bool = field(default_factory=bool)
    trust_libcurl_status: str = field(default_factory=str)
    trust_elixir: bool = field(default_factory=bool)
    trust_elixir_status: str = field(default_factory=str)
    trust_dart: bool = field(default_factory=bool)
    trust_dart_status: str = field(default_factory=str)
